...
+ (CustomerAddressType *) customerAddressType {
    CustomerAddressType *c = [[[CustomerAddressType alloc] init] autorelease];
    return c;
}
...
- (NSString *) description {
    NSString *output = [NSString stringWithFormat:@""
                        ...
                        @"CustomerAddressType.customerAddressId = %@\n",
                        self.firstName,
                        self.lastName,
                        self.address,
                        self.city,
...
- (NSString *) stringOfXMLRequest 
{
	NSString *s = [NSString stringWithFormat:@""
                   ...
                   ((self.customerAddressId == nil) ? @"" : [NSString stringWithXMLTag:@"customerAddressId" andValue:self.customerAddressId])
                   ];
...
+ (CustomerAddressType *)buildCustomerAddressType:(GDataXMLElement *)element {
    ...
    c.customerAddressId = [NSString stringValueOfXMLElement:element withName:@"customerAddressId"];
    return c;
}
