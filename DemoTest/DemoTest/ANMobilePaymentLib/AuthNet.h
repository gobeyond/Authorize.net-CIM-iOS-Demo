...
@property (nonatomic, retain) id <AuthNetDelegate> delegate;
@property (nonatomic, retain) AuthNetRequest *request;
@property (nonatomic, retain) UIViewController *rootvc;
@property (nonatomic) AUTHNET_ENVIRONMENT environment;
@property (nonatomic, retain) MerchantAuthenticationType *merchantAuthentication;
@property (nonatomic, retain) NSString *sessionToken;
@property NSInteger duplicateWindowValue;
@property (nonatomic, retain) NSMutableData *responseData;
@property BOOL isPendingResponse;
@property (nonatomic, retain) AuthNetResponse *response;
